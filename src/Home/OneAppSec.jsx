      ...
      >
        <div className="w-[43%] max-w-[473px] space-y-[20px]">
         <div className="space-y-[10px]">
          <h4 className="px-2 h-[29px] flex items-center max-w-[180px] text-[14px] text-[#030F16] bg-[#E9C03D] rounded-[7px] "> <span className="text-[40px] !mb-[22px] mr-[3px] leading-[0px] animate-blink">.</span> Live Now (Beta Phase)</h4>
