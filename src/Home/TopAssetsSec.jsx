            ...
            <div className="relative grid grid-cols-4 gap-x-[18px]">
              ...
              > */}
                ...
                <SwiperSlide> */}
                  <div className="border pt-[26px] pb-[51px] px-[26px] border-[#9D9D9D] bg-[#fff] rounded-[8px] w-[256px] h-[355px] space-y-[13px]">
                    <div className="flex items-center flex-col space-y-[10px]">
                      <img src={cardicn2} alt="" className="w-[54.72px] h-[54.72px]" />
                      <div className="flex items-center space-x-4">
                        <h3 className="text-[#000] text-[18px] font-[600]">
                          Apple Inc.
                        </h3>
                ...
                <SwiperSlide> */}
                  <div className="border pt-[26px] pb-[51px] px-[26px] border-[#9D9D9D] bg-[#fff] rounded-[8px] w-[256px] h-[355px] space-y-[13px]">
                    <div className="flex items-center flex-col space-y-[10px]">
                      <img src={cardicn3} alt="" className="w-[54.72px] h-[54.72px]" />
                      <div className="flex items-center space-x-4">
                        <h3 className="text-[#000] text-[18px] font-[600]">
                          Gold
                        </h3>
                ...
                <SwiperSlide> */}
                  <div className="border pt-[26px] pb-[51px] px-[26px] border-[#9D9D9D] bg-[#fff] rounded-[8px] w-[256px] h-[355px] space-y-[13px]">
                    <div className="flex items-center flex-col space-y-[10px]">
                      <img src={cardicn4} alt="" className="w-[54.72px] h-[54.72px]" />
                      <div className="flex items-center space-x-4">
                        <h3 className="text-[#000] text-[18px] font-[600]">
                          Microsoft
                        </h3>
              ...
              {/* <button className="swiper-button-prev rotate-[180deg]  absolute z-10 !left-[-5%] top-[50%] transform -translate-y-1/2">
                <img
