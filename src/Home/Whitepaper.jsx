          ...
          <div className="w-[50%] space-y-4">
            ...
            <div className="w-full p-2 flex flex-col justify-start">
              ...
              <p className="text-[14px]">
                Explore the BlockchainFX whitepaper to see how the $BFX token powers a next-generation trading ecosystem.
                Discover its key features, benefits, and how BlockchainFX is bridging the gap between crypto and traditional
                finance while creating the first super app in the industry.
              </p>
            </div>
