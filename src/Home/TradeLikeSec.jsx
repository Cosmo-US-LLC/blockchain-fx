...
function TradeLikeSec() {
  return (
    <div className="pt-[98px] space-y-[35px] pb-[92px]">
      <div className="max-w-[1220px] space-y-[60px] w-[100%] mx-auto ">
        <div className="flex justify-between items-center">
          <div className="space-y-[40px] max-w-[453px]">
            <h3 className="text-[50px] capitalize font-[700] leading-[95%] text-[#181A20] tracking-[-1px]">
              Trade Like a Pro
            </h3>
          ...
          <div className="max-w-[600px] space-y-[16px] w-[100%]">
            ...
            className="flex justify-between items-center border border-[#9D9D9D] rounded-[100px] px-[39px] py-[29px]">
              <div className="flex items-center space-x-8">
                <div className="max-w-[50px] w-[100%]">
                  <img src={trd1cn1} alt="" />
                </div>
                <h4 className="text-[25px] font-[600] text-[#181A20]">
                  Momentum
                </h4>
              </div>
              <div className="w-[99px] h-[47px] rounded-[100px] flex items-center justify-center border border-[#9D9D9D] bg-[#fff]">
                <h3 className="text-[25px] font-[600] text-center text-[#E5AE00]">21</h3>
              </div>
            </div>
            <div 
            style={{
            ...
            className="flex justify-between items-center border border-[#9D9D9D] rounded-[100px] px-[39px] py-[29px]">
              ...
              <div className="w-[99px] h-[47px] rounded-[100px] flex items-center justify-center border border-[#9D9D9D] bg-[#fff]">
                <h3 className="text-[25px] font-[600] text-center text-[#E5AE00]">10</h3>
              </div>
            </div>
            <div 
            style={{
            ...
            className="flex justify-between items-center border border-[#9D9D9D] rounded-[100px] px-[39px] py-[29px]">
              ...
              <div className="w-[99px] h-[47px] rounded-[100px] flex items-center justify-center border border-[#9D9D9D] bg-[#fff]">
                <h3 className="text-[25px] font-[600] text-center text-[#E5AE00]">13</h3>
              </div>
            </div>
            <div 
            style={{
            ...
            className="flex justify-between items-center border border-[#9D9D9D] rounded-[100px] px-[39px] py-[29px]">
              ...
              <div className="w-[99px] h-[47px] rounded-[100px] flex items-center justify-center border border-[#9D9D9D] bg-[#fff]">
                <h3 className="text-[25px] font-[600] text-center text-[#E5AE00]">7</h3>
              </div>
            </div>
            <div 
            style={{
            ...
            className="flex justify-between items-center border border-[#9D9D9D] rounded-[100px] px-[39px] py-[29px]">
              ...
              <div className="w-[99px] h-[47px] rounded-[100px] flex items-center justify-center border border-[#9D9D9D] bg-[#fff]">
                <h3 className="text-[25px] font-[600] text-center text-[#E5AE00]">4</h3>
              </div>
            </div>
            <div 
            style={{
            ...
            className="flex justify-between items-center border border-[#9D9D9D] rounded-[100px] px-[39px] py-[29px]">
              ...
              <div className="w-[99px] h-[47px] rounded-[100px] flex items-center justify-center border border-[#9D9D9D] bg-[#fff]">
                <h3 className="text-[25px] font-[600] text-center text-[#E5AE00]">23</h3>
              </div>
            </div>
          </div>
        </div>
