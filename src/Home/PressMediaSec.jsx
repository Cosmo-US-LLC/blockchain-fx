        ...
        <div className="flex gap-x-4 justify-center">
          <div className="bg-[#111] max-w-[400px] rounded-[8px] px-[17.6px] py-[37px] w-[100%]" style={{ border: "1px solid rgba(230, 175, 3, 0.12)" }}>
            <div className="space-y-[25px]">
              ...
              <a href={"https://coinmarketcap.com/community/articles/67d43c30c4a5810cf71d7406/"} target="_blank" className="text-[15px] flex justify-center underline text-[#E5AE00]" rel="noopener noreferrer">
              Read Article
              </a>
            </div>
          </div>
          <div className="bg-[#111] max-w-[400px] rounded-[8px] px-[17px] py-[37px] w-[100%]" style={{ border: "1px solid rgba(230, 175, 3, 0.12)" }}>
            <div className="space-y-[25px]">
              ...
              <a href={"https://www.binance.com/en/square/post/21135762162242"} target="_blank" className="text-[15px] flex justify-center underline text-[#E5AE00]" rel="noopener noreferrer">
              Read Article
              </a>
            </div>
          </div>
          <div className="bg-[#111] max-w-[400px] rounded-[8px] px-[17.6px] pt-[37px] pb-[29px] w-[100%]" style={{ border: "1px solid rgba(230, 175, 3, 0.12)" }}>
            <div className="space-y-[25px]">
              ...
              <a href={"https://techbullion.com/blockchainfx-the-first-ever-platform-where-you-can-trade-bitcoin-btc-apple-aapl-instantly/"} target="_blank" className="text-[15px] flex justify-center underline text-[#E5AE00]" rel="noopener noreferrer">
              Read Article
              </a>
            </div>
          </div>
