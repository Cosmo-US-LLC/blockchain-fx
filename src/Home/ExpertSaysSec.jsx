...
function ExpertSaysSec() {
  ...
  return (
    <div className="flex items-center bg-[#020B10] py-[50px]">
      <div className="max-w-[1200px] flex justify-between items-center gap-[2rem] w-[100%] mx-auto border border-[#E6AF03] bg-[#030F16] relative rounded-[24px] px-[30px] pt-[50px] pb-[100px]">
         <Swiper
          modules={[Navigation]}
          spaceBetween={20}
          slidesPerView={1}
        ...
        >
          ...
          <SwiperSlide>
            <div className="flex items-center gap-5">
              ...
              <div className="rounded-[16px] py-2 px-3 max-w-[266px]" style={{
                background:"",
                border:"1px solid rgba(255, 255, 255, 0.10)",
            }}>
                <h4 className="text-[#898989] text-[16px] font-[400]">What Experts Say About BFX</h4>
            </div>
                ...
                <img src={stars} alt="" />
                <div>
                <h3 className="text-[#D8D8D8] text-[18px] font-[600]">— Crypto Volt</h3>
                <p className="text-[#898989] text-[16px] font-[400]">Crypto Youtuber, 178K Followers</p>
            </div>
              </div>
              <div className="w-[50%]">
          ...
          <SwiperSlide>
            <div className="flex items-center gap-5">
              ...
              <div className="rounded-[16px] py-2 px-3 max-w-[266px]" style={{
                ...
                <img src={stars} alt="" />
                <div>
                <h3 className="text-[#D8D8D8] text-[18px] font-[600]">— Crypto Dealer</h3>
                <p className="text-[#898989] text-[16px] font-[400]">Youtuber, 102K Followers</p>
                </div>
              </div>
              <div className="w-[50%]">
