...
export default function BiggestBuy() {
  ...
  const tableData = [
    { rank: 1, wallet: "0x589...18e01", date: "2025-05-02", txCount: 3, totalBuy: "$124,590.58", nft: "Legend", prize: "$60,000" },
    { rank: 2, wallet: "0x2b...b37d", date: "2025-11-04", txCount: 2, totalBuy: "$63,560.79", nft: "Elite", prize: "$20,000" },
    { rank: 3, wallet: "0x6ce...62f8", date: "2025-05-03", txCount: 15, totalBuy: "$92,169.19", nft: "Elite", prize: "$10,000" },
    { rank: 4, wallet: "0x71c...9ec98", date: "2023-10-06", txCount: 13, totalBuy: "$35,143.44", nft: "Master", prize: "$5,000" },
    { rank: 5, wallet: "0x5e...7676", date: "2023-09-04", txCount: 4, totalBuy: "$24,710.55", nft: "Expert", prize: "$3,000" },
    { rank: 6, wallet: "0x03...109c", date: "2025-05-06", txCount: 5, totalBuy: "$62,845.92", nft: "Master", prize: "$5,000" },
    { rank: 7, wallet: "0x3b...92f7", date: "2025-07-07", txCount: 2, totalBuy: "$45,000.00", nft: "Expert", prize: "$2,000" },
    { rank: 8, wallet: "0x72...91b0", date: "2025-06-10", txCount: 3, totalBuy: "$37,400.00", nft: "Elite", prize: "$8,000" },
    { rank: 9, wallet: "0xa9...24b5", date: "2025-03-15", txCount: 4, totalBuy: "$40,210.00", nft: "Legend", prize: "$15,000" },
    { rank: 10, wallet: "0x89...c74e", date: "2025-02-20", txCount: 1, totalBuy: "$15,729.20", nft: "NFT", prize: "$1,000" }
  ];
    ...
    <div className="flex items-center justify-center bg-[#000] pt-[50px] pb-[50px] px-[80px]">
      <div className="p-6 w-full max-w-[1200px] overflow-hidden relative min-h-[550px] bg-no-repeat bg-cover bg-center rounded-[16px] bg-[#111]">
        <div className="flex flex-col justify-center items-center relative z-10 space-y-[29px] mb-[25px]">
          <h4 className="text-[40px] font-[800] text-white leading-[120%]">Biggest Buy-In Competition</h4>
          ...
          <table className="table-auto w-full text-white">
            ...
            <tbody>
              {visibleData.map((item, index) => (
                <tr key={index}  className={` ${index < 3 ? "text-[#FFF9AD] " : ""}`}>
                  ...
                  <td className="px-4 py-2">{item.prize}</td>
                </tr>
              ))}
            </tbody>
          </table>
