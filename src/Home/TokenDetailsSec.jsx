    ...
    <div className="pt-[50px] space-y-[35px] bg-[#FAFAFA] pb-[50px] px-[152px]">
      ...
      <div className="w-[100%] mx-auto flex justify-between items-center ">
        <div className="max-w-[363px] w-[100%] border px-[24px] pt-[17px] pb-[16px] border-[#000]">
            ...
            <h3 className="text-[#444] text-[20px] font-[700]">BlockchainFX</h3>
        </div>
        <div className="max-w-[363px] w-[100%] border px-[24px] pt-[17px] pb-[16px] border-[#000]">
            <h4 className="text-[#444] text-[16px] font-[400]">Launch on</h4>
            <h3 className="text-[#444] text-[20px] font-[700]">Uniswap and CEX</h3>
        </div>
        <div className="max-w-[363px] w-[100%] border px-[24px] pt-[17px] pb-[16px] border-[#000]">
            <h4 className="text-[#444] text-[16px] font-[400]">Token Type</h4>
            <h3 className="text-[#444] text-[20px] font-[700]">Ethereum</h3>
        </div>
       ...
       <div className="w-[100%] mx-auto flex justify-between items-center ">
        <div className="max-w-[363px] w-[100%] border px-[24px] pt-[17px] pb-[16px] border-[#000]">
            ...
            <h3 className="text-[#444] text-[20px] font-[700]">$BFX</h3>
        </div>
        <div className="max-w-[363px] w-[100%] border px-[24px] pt-[17px] pb-[16px] border-[#000]">
            <h4 className="text-[#444] text-[16px] font-[400]">Decimal</h4>
            <h3 className="text-[#444] text-[20px] font-[700]">18</h3>
        </div>
        <div className="max-w-[363px] w-[100%] border px-[24px] pt-[17px] pb-[16px] border-[#000]">
            <h4 className="text-[#444] text-[16px] font-[400]">Total Supply</h4>
            <h3 className="text-[#444] text-[20px] font-[700]">3.5B</h3>
        </div>
       ...
       <div className="w-[100%] mx-auto flex justify-between items-center ">
        <div className="border px-[24px] w-[100%] pt-[17px] pb-[16px] border-[#000]">
            ...
            <h3 className="text-[#444] flex text-[20px] font-[700]">0xfe588f4cfaf1126446d421cf00ec50cbe19b70cf <img src={copy} className="pl-2" alt="" /></h3>
        </div>
       </div>
      </div>
      </div>
