...
function WhatIsSec() {
  ...
  return (
    <div className="pt-[77px] space-y-[35px] pb-[45px] bgwhat" id="what-is-bfx-coin">
      <div className="max-w-[866px] relative -space-y-[30px] w-[100%] mx-auto ">
       ...
       <div className="max-w-[664px] w-[100%] mx-auto pt-[0rem] pb-[8rem]">
        <img src={whatisimg} className="!ml-[15px] pt-[-15px]" alt="" />
       </div>
