...
function FeaturedSec() {
  ...
  return (
    <div className="pt-[25px] bg-[#000]">
      <div className=" ">
        <div className="w-[100%] mx-auto">
          <div className="bg-[#000] flex relative z-[99] justify-center items-center h-[73.47] space-x-[20px] border border-[#262626] rounded-[13.357px] py-[25px] max-w-[1200px] w-[100%] mx-auto">
