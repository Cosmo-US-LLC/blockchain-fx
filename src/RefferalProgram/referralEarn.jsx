      ...
      <div className="max-w-[1200px] relative w-[100%] mx-auto">
        ...
        <div className="flex flex-col sm:flex-row justify-center items-stretch space-x-[0px] sm:space-x-[40px] pt-[40px] px-[4%] sm:px-[0%] w-[100%] h-full">
          <div className="w-[100%] sm:w-[50%]">
            ...
            >
              <div>
                <p className="text-[15px] sm:text-[16px] font-[600] pt-[16px] px-[16px] sm:px-[20px] leading-[120%] tracking-[-1px] text-[#D99A26] ">
                  Step 1: Connect Your Wallet
                </p>
              </div>
              <div>
                <p className="text-[15px] sm:text-[16px] font-[400] leading-[120%] tracking-[-1px] text-[#fff] py-[16px] sm:py-[24px] px-[16px] sm:px-[24px]">
            ...
            <div className="bg-[#242424] w-[100%] mt-[20px]">
              ...
              <div>
                <p className="text-[15px] sm:text-[16px] font-[400] leading-[120%] tracking-[-1px] text-[#fff] pt-[16px] sm:pt-[24px] px-[16px] sm:px-[20px]">
                  You’ll receive a unique referral code.
                </p>
                <p className="text-[15px] sm:text-[16px] font-[400] leading-[120%] tracking-[-1px] text-[#fff] pb-[16px] sm:pb-[24px] pt-[4px] sm:pt-[10px] px-[16px] sm:px-[20px]">
            ...
            <div className="bg-[#242424] w-[100%] mt-[20px]">
              ...
              <div>
                <p className="text-[15px] sm:text-[16px] font-[400] leading-[120%] tracking-[-1px] text-[#fff] pr-[10px] pt-[16px] sm:pt-[24px] pl-[16px] sm:pl-[20px]">
                  Anyone who uses your referral code and buys $100 or more will
                  get automatically 30% more BFX added to their purchase.
                </p>
                <p className="text-[15px] sm:text-[16px] font-[400] leading-[120%] tracking-[-1px] text-[#fff] pt-[16px] sm:pt-[20px] pb-[16px] sm:pb-[24px] pl-[16px] sm:pl-[20px] pr-[10px]">
            ...
            <div className="bg-[#242424] w-full mt-[20px]">
              ...
              <div>
                <p className="text-[15px] sm:text-[16px] font-[400] leading-[120%] tracking-[-1px] text-white pt-[16px] sm:pt-[24px] pl-[16px] sm:pl-[20px] pr-[10px]">
                  Monitor your referral earnings right from your wallet.
                </p>
                <p className="text-[15px] sm:text-[16px] font-[400] leading-[120%] tracking-[-1px] text-white pb-[16px] sm:pb-[24px] pt-[5px] sm:pt-[10px] pl-[16px] sm:pl-[20px] pr-[10px]">
            ...
            <div className="bg-[#242424] w-full mt-[20px]">
              ...
              <div>
                <p className="text-[15px] sm:text-[16px] font-[400] leading-[120%] tracking-[-1px] text-white py-[16px] sm:py-[24px] pl-[16px] sm:pl-[20px] pr-[10px]">
