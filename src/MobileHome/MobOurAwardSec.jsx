    ...
    <div className="pt-[24px]  bg-[#000] pb-[24px]" id="win">
      <div className="relative space-y-[20px] w-[90%] mx-auto ">
        ...
        <div className=" space-y-[40px]">
         <div className="space-y-[10px] px-[80px] max-h-[673px] pt-[15px] rounded-[12.839px] w-[100%]"
         style={{
            background:"#030F16",
         ...
         >
            <div className="space-y-[10px] max-w-[324.48px] h-[160px] flex items-center justify-center flex-col w-[100%] relative mx-auto pb-[2.4rem]">
                <div className="flex flex-col items-center pb-2">
                  <h3 className="text-[7px] text-center text-[#FFF] uppercase font-[700]">TheCoinRisE</h3>
                <p className="text-[10px] text-center leading-[115%] uppercase text-[#FFF] font-[400]">Best Trading <br /> Platform <br /> 2025 </p>
                </div>
         ...
         <div className="space-y-[10px] px-[60px] max-h-[673px] pt-[15px] rounded-[12.839px] w-[100%]"
         style={{
            background:"#030F16",
            backdropFilter:"blur(49.51113510131836px)",
            border: "1.102px solid rgba(230, 175, 3, 0.12)"
         ...
         >
            <div className="space-y-[10px] max-w-[324.48px] h-[160px] flex items-center justify-center flex-col w-[100%] relative mx-auto pb-[2.4rem]">
                <div className="flex flex-col items-center pb-2">
                  <h3 className="text-[7px] text-center text-[#FFF] uppercase font-[700]">AltcoinDaily</h3>
                <p className="text-[10px] text-center leading-[115%] uppercase text-[#FFF] font-[400]">Fastest Growing  <br /> Trading Broker <br /> 2025 </p>
                </div>
                <img src={rwdimg1} className="max-w-[194px] w-[100%] absolute top-[-3%]"  alt="" />
            </div>
            <div className="">
