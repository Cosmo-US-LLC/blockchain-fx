        ...
        <div className="pt-[22px] px-6 mx-auto ">
          <div className="space-y-[16px]">
            {cardItems.map((item) => (
              <div
                key={item.id}
                className="py-6 px-4 rounded-[16px] bg-[#030F16] flex flex-col justify-center gap-4  border-[rgba(230,175,3,0.12)]   border"
              >
                ...
                ></h3>
                <h4 className="text-[15px] mx-auto text-center text-[#8497A2] font-[400] leading-[160%] tracking-[-0.3182px]">
                  {item.description}
                </h4>
              </div>
            ))}
