...
export default function YoutubeSec() {
  ...
  return (
    ...
    >
      <img className="absolute" src={'assets/blockchainfx/ExpertSays2/eclipse.svg'} alt="eclipse" />
    <div
      ...
      >
        ...
        <div>
          ...
          <img className="mt-3" src={'assets/blockchainfx/ExpertSays2/Stars.svg'} alt="stars" />
