  ...
  return (
    <div className="pt-[20px] pb-[24px] space-y-[28px] w-[90%] mx-auto " id="Wallet">
       <div className="flex justify-center space-x-3 items-center">
          ...
          <div className="w-[55px] text-[14.106px] font-[600] text-[#fff] rounded-[7px] bg-[#E9C03D] h-[22px] flex justify-start pl-[5px] items-start">
            <span className="text-[28px] leading-[9%] mt-[1px] pr-[2px] animate-blink">.</span>
            Live
          </div>
        </div>
        <div
        ...
        >
          ...
          <div className="flex justify-center space-x-[30px]">
            <div className=" space-y-[5px]">
              ...
              <p className="text-center text-[#444] text-[7.085px] font-[700]">
                DAYS
              </p>
            </div>
            <div className=" space-y-[5px]">
      ...
      <div
        ...
        className="max-w-[838px] space-y-[10px] rounded-[13px] px-[21px] pt-[24px] pb-[20px] border border-[#B0B0B0]  relative "
      >
        ...
        <div className="space-y-[4px] !mt-[3px]">
          <label className="text-[#2F2F2F] text-[8px] font-[700] leading-[100%]">
            You Pay in USDT:
          </label>
      ...
      <div
            ...
            className="max-w-[413.763px] space-y-[10px] relative rounded-[6.419px] px-[22px] pt-[22px] pb-[25px] max-h-[554.944px] border border-[#B0B0B0] w-[100%] mx-auto "
          >
                      ...
                      <div className=" w-[100%] flex flex-col justify-center">
                        ...
                        <div
                          className={` transition-all duration-300 desc  ${
                            index === activeIndexbuy
                              ? "max-h-[200px] opacity-100 mt-[8px]  text-[10px] font-[400] text-[#000] overflow-hidden block"
      ...
      <div  className="space-y-[25px] px-[38px] pt-[20px] pb-[25px] border border-[#B0B0B0] w-[100%] mx-auto "
       style={{
        background: "rgba(237, 237, 237, 0.40)",
      }}>
      <div
        ...
        >
          ...
          <div>
            <img src={cer} className="w-[130.995px]"  alt="" />
          </div>
        </div>
      </div>
    </div>
