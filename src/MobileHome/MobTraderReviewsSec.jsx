...
function MobTraderReviewsSec() {
  return (
    <div className="pt-[24px] space-y-[20px] bg-[#000]" id="reviews">
          ...
          <div className="w-[100%] pt-[35px]">
            <div className="relative">
              <div className="max-w-[300px] flex space-x-3 mx-auto">
                <button className="swiper-button-prev-3 !w-[40px] !h-[40px]  absolute z-10 !left-[0%] !top-[45%]  ">
                  <img
                ...
                <button className="swiper-button-next-3 rotate-[180deg] !w-[40px] !h-[40px]  absolute z-10 !right-[0%] !top-[45%] ">
                  <img
                    className="w-[40.545px] h-[40.545px]"
                    src={swpbtn}
                    alt=""
