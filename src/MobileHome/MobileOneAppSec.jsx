      ...
      <div className="flex flex-col relative border-[1px] border-[#343434] rounded-[24px] px-2 py-[30px]">
        <div className="space-y-[20px]">
            ...
            {items.map((item, index) => (
              ...
              >
                ...
                >
                  ...
                  <div className="">
                    <img
                      src={activeIndex === index ? "assets/blockchainfx/OneApp2/iconopen%20(2).svg" : "assets/blockchainfx/OneApp2/iconopen%20(1).svg"}
          ...
          <div className="w-[100%] flex justify-center !mt-10">
            <img src={'assets/blockchainfx/OneApp2/dailyimgmob.png'} className="object-cover" alt="Blockchainfx one app" />
          </div>
