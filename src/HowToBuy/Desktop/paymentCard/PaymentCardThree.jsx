...
function PaymentCardThree() {
  return (
    <div className="bg-[#0F0F0F] border border-[#3F3F3F] rounded-xl px-6 py-6 flex items-center justify-between gap-10 w-full max-w-[808px]">
      ...
      <div className="flex flex-col gap-3 w-[360px]">
        ...
        <div className="bg-[#FFFFFF17]   rounded-lg px-4 py-2">
          ...
          <div className="flex items-center justify-between">
            ...
            <div className="flex items-center gap-2 px-2 py-1 bg-[#2A2A2A] rounded-lg">
