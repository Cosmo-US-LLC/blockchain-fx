...
const LaunchPopup = () => {
  ...
  return (
    <div className="fixed inset-0 z-[9999] flex items-center justify-center bg-black/80 backdrop-blur-sm p-4">
      <div className="relative overflow-hidden w-full max-w-[800px] 2xl:min-h-[auto] xl:min-h-[auto] lg:min-h-[auto] md:min-h-[auto] sm:min-h-[620px] border-2 2xl:!border-l-2 xl:!border-l-2 lg:!border-l-2 md:!border-l-2 sm:!border-l-0 !border-l-0 2xl:!border-r-2 xl:!border-r-2 lg:!border-r-2 md:!border-r-2 sm:!border-r-0 !border-r-0 border-[#E5AE00] min-h-[620px]  rounded-2xl overflow-hidden ">
  ...
  <path d="M12.75 0.75L0.75 12.75M12.75 12.75L0.75 0.75" stroke="white" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
        ...
        <div className="p-8 relative z-[9] md:p-12 text-center md:text-left flex flex-col md:flex-row items-center gap-8">
          <div className="flex-1 ]">
            <h2 className="text-white 2xl:text-[40px] lg:text-[40px] md:text-[40px] sm:text-[40px] text-[24px] font-[900] leading-[105%] mb-2 uppercase uppercase">
              Get Ready For <br />
              <span className="text-[#E5AE00]">The BFX Launch!</span>
            </h2>
            <p className="text-[#fff] 2xl:font-[700] xl:font-[700] lg:font-[700] md:font-[700] sm:font-[700] font-[600] 2xl:text-[16px] xl:text-[16px] md:text-[16px] sm:text-[16px] text-[14px] 2xl:mb-6 xl:mb-6 lg:mb-6 md:mb-6 sm:mb-4 mb-4">Trading App goes Live on January 31st.</p>
            
            <div className="space-y-3 font-[400] text-[#fff] 2xl:text-[16px] xl:text-[16px] md:text-[16px] sm:text-[16px] text-[14px] leading-relaxed max-w-[360px]">
