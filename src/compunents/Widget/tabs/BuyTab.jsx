    ...
    <>
      <div className="gap-[10px] justify-between flex flex-col relative w-full min-h-full isolate">
        ...
        </div>
        {
          ...
          >
              <h3 className="max-md:text-[10px] md:text-[9px] 2xl:max-w-[100%] xl:max-w-[100%] lg:max-w-[100%] md:max-w-[100%] sm:max-w-[222px] max-w-[222px] mx-auto font-[500]  text-white text-center ">
