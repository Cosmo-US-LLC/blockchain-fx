        ...
        </div>
        {
          ...
          >
              <h3 className="2xl:text-[10px] xl:text-[10px] lg:text-[10px] md:text-[10px] sm:text-[11px] text-[11px] 2xl:max-w-[240px] xl:max-w-[240px] lg:max-w-[240px] md:max-w-[240px] sm:max-w-[215px] max-w-[215px] mx-auto font-[500]  text-white text-center ">
                <span className="font-[700]">{t('buy_tab.limited_time_offer_1')} </span> {t('buy_tab.use_bonus_code_1')} <span className="text-[#2FD942] !font-[700]">{t('buy_tab.code_1')}</span> <br /> {t('buy_tab.to_get')}
