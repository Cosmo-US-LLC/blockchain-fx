...
const WalletPopup = ({ onClose }) => {
  return (
    ...
    className="fixed inset-0 bg-black bg-opacity-50 p-2 flex justify-end items-start">
      ...
      className="bg-[#181818] border border-[#3D3D3D] p-6 rounded-lg shadow-lg w-[100%] max-w-[487px] px-[30px] py-[24px] rounded-[8px] mt-[4rem] 2xl:mr-10 xl:mr-10 lg:mr-10 md:mr-0 sm:mr-0 mr-0">
