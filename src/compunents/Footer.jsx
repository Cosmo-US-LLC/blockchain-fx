...
function Footer() {
  ...
  const supportedLangs = [
    "en","vi","de","nl","ja","tr","ko","it","no","zh","ru","fr","pt","es","ar",
  ];
   ...
   <div className="w-[100%] 2xl:block xl:block lg:block md:block sm:hidden hidden space-y-[40px] max-w-[1200px]  pt-[50px] mx-auto pb-[50px] ">
        <div className="flex justify-between">
          ...
          <div className="max-w-[285px] space-y-[10px] w-[100%] pt-[12px]">
            <h4 className="text-white text-[20px] font-[600]">{t("footer.socials.title")}</h4>
            <div className="flex space-x-6 pt-[10px] pb-[20px]">
              <a href="https://t.me/blockchainfx_chat" target="_blank" rel="noopener noreferrer">
      ...
      {/* mobile version */}
          ...
          <div className="max-w-[200px] w-[100%] ">
            <ul className=" w-[100%]">
              <li className="text-[#fff] text-[16px] font-[600] leading-[108.333%]">
                ...
                <a href="https://t.me/blockchainfx_chat" target="_blank" rel="noopener noreferrer" className="text-[#fff] text-[13px] pt-[20px] block font-[400] hover:border-b-[#E5AE00] transition duration-300 inline-block">
                  {t("footer.docs.support")}
                </a>
              </li>
            </ul>
        ...
        <div className="flex justify-between">
          <div className="max-w-[285px] space-y-[25px] w-[100%] ">
            <h4 className="text-[#fff] text-[16px] font-[600]">{t("footer.socials.title")}</h4>
            <div className="flex space-x-6">
              <a href="https://t.me/blockchainfx_chat" target="_blank" rel="noopener noreferrer">
                <img className="w-[24px] h-[24px]" src={socil2 || "/placeholder.svg"} alt="telegram" />
              </a>
              <a href="https://x.com/BlockchainFXcom" target="_blank" rel="noopener noreferrer">
                <img className="w-[24px] h-[24px]" src={socil3 || "/placeholder.svg"} alt="twitter" />
              </a>
            </div>
            <div className="space-y-[10px]">
              <h4 className="text-[#fff] text-[12px] font-[400]">{t("footer.contact.email_label")}</h4>
              <h3 className="text-[#fff] text-[15px] font-[400]">{t("footer.contact.email")}</h3>
            </div>
          </div>
        </div>
