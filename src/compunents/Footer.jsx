      ...
      <div className="w-[100%] 2xl:block xl:block lg:block md:block sm:hidden hidden space-y-[40px] max-w-[1076px]  pt-[50px] mx-auto pb-[50px] ">
        ...
        <div className='flex justify-between w-[60%]'>
          <div className='max-w-[177px] space-y-[10px] w-[100%]'>
            <img src={logo} alt="" />
            <p className='text-[#000] text-[12px] font-[400] leading-[166.667%]'>Experience all-in-one trading with BlockchainFX: Trade Crypto, Forex, ETFs, Stocks, Indices, CFDs, and more with access to over 500 assets.</p>
          </div>
          <div className='max-w-[83.276px] w-[100%] pt-[15px]'>
            <ul>
              ...
              Quick Links
                ...
                <a className='text-[#949494] block text-[10.8px] pt-[10px] font-[400] leading-[108.333%]' href="" onClick={(e) => handleScroll(e, "roadmap", 90)} >Roadmap</a>
                <a className='text-[#949494] block text-[10.8px] pt-[10px] font-[400] leading-[108.333%]' href="" onClick={(e) => handleScroll(e, "tokenomics", 90)} >Token Allocation</a>
              </li>
            </ul>
          </div>
        ...
        <div className='max-w-[285px] space-y-[10px] w-[100%] pt-[12px]'>
          <h4 className='text-[#000] text-[13.3px] font-[600] leading-[108.333%]'>Join Our Socials</h4>
          ...
          <div className='space-y-[5px]'>
            <h4 className='text-[#949494] text-[10.8px] font-[400] leading-[108.333%]'>Contact E-Mail: </h4>
