...
import socil1 from "../assets/footer/Instagram.png";
import socil2 from "../assets/footer/TelegramApp.png";
import socil3 from "../assets/footer/X.png";
import socil4 from "../assets/footer/Facebook.png";
      ...
      <div className="w-[100%] 2xl:block xl:block lg:block md:block sm:hidden hidden space-y-[40px] max-w-[1200px]  pt-[50px] mx-auto pb-[50px] ">
        <div className="flex justify-between">
          ...
          <div className="max-w-[285px] space-y-[10px] w-[100%] pt-[12px]">
            <h4 className="text-white text-[20px] font-[600] leading-[120%]">
              Join Our Socials
            </h4>
        ...
        <div className="border-t border-b border-white/10 py-[46px]">
          <p className="text-[14px] font-[400] text-[#8497A2] leading-[171%]">
            ...
            is crucial. BlockchainFX does not guarantee any performance,
            outcome, or return of capital for any cryptocurrency mentioned on
            this platform. By using this platform, you agree to our Terms of
            Service, Privacy Policy, Cookie Policy, and any applicable token
            sale agreements. The platform's content is not intended for use in
